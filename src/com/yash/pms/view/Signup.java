...
public class Signup extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Your Favourite Game",
				"Your Favourite Bike", "Your Favourite City", "Your Favourite Book", "Your Favourite Phone" }));
		...
		jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 340, -1, 30));
		...
		jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/h.png"))); // NOI18N
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		if (txtname.getText().equals("")) {
			...
			try {
				...
				boolean isEmailUsed = UserDao.CheckeEmailExist(txtemail.getText());
				if (isEmailUsed) {
					JOptionPane.showMessageDialog(this, "Use Another Email ID");
					txtemail.requestFocus();
				} else {
					int count = UserDao.createUser(txtname.getText(), txtemail.getText().toLowerCase(),
							txtpassword.getText(), jComboBox1.getItemAt(jComboBox1.getSelectedIndex()),
							txtans.getText());
					if (count > 0) {
						JOptionPane.showMessageDialog(this, "Registered Successfully\nLogin Now");
						SignIn.signInScreen.setVisible(true);
						Signup.signUpScreen.setVisible(false);
	...
	private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jLabel9MouseClicked
		...
		if (flag == 0) {
			jLabel9.setIcon(new ImageIcon(
					"C:\\Users\\Sudhir\\OneDrive\\Pictures\\Documents\\NetBeansProjects\\Hotel Management System\\src\\s.png"));
			flag = 1;
			txtpassword.setEchoChar((char) 0);
		} else {
			jLabel9.setIcon(new ImageIcon(
					"C:\\Users\\Sudhir\\OneDrive\\Pictures\\Documents\\NetBeansProjects\\Hotel Management System\\src\\h.png"));
			flag = 0;
